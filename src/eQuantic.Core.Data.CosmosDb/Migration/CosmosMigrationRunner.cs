...
/// </summary>
public sealed class CosmosMigrationRunner : IMigrationRunner
{
    ...
    public CosmosMigrationRunner(IMigrationExecutor executor, IMigrationHistory history, IEnumerable<Assembly> assemblies)
    {
        _executor = executor;
        _history = history;
